...
new Alfresco.component.CreateUser("${id}").setMessages(${messages});
//]]></script>
            ...
            <div id="${id}-form-fields" class="form-fields">
                ...
                <div class="set">
                    <div class="form-field">
                        ...
                        <label for="${id}_prop_frm_firstName">First
                            name:<span class="mandatory-indicator">*</span></label>

                        <input id="${id}_prop_frm_firstName" name="prop_frm_firstName" tabindex="0" type="text" value=""
                               maxlength="1024"/>

                        <span class="help-icon">
                            <img id="${id}_prop_frm_firstName-help-icon"
                                 src="/share/res/components/form/images/help.png"
                                 title="Click to show and hide help text for the field." tabindex="0"/>
                        </span>

                        <div class="help-text"
                             id="${id}_prop_frm_firstName-help">
                            Please, provide your first name
                        </div>
                    </div>

                    <div class="form-field">
                        <label for="${id}_prop_frm_lastName">Last
                            name:</label>
                        <input id="${id}_prop_frm_lastName" name="prop_frm_lastName" tabindex="0" type="text" value=""
                               maxlength="1024"/>

                          <span class="help-icon">
                             <img id="${id}_prop_frm_lastName-help-icon"
                                  src="/share/res/components/form/images/help.png"
                    ...
                    <div class="form-field">
                        <label for="${id}_prop_frm_email">E-mail:<span class="mandatory-indicator">*</span></label>

                        <input id="${id}_prop_frm_email" name="prop_frm_email" tabindex="0" type="text" value=""
                               maxlength="1024"/>

                        <span class="help-icon">
                            <img id="${id}_prop_frm_email-help-icon"
                                 src="/share/res/components/form/images/help.png"
                                 title="Click to show and hide help text for the field."
                                 tabindex="0"/>
                        </span>
