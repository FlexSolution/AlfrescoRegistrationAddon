                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <div style="font-size: 14px; margin: 12px 0px 24px 0px; padding-top: 10px; border-top: 1px solid #aaaaaa;">
                                                    ...
                                                    <p>${creator.firstname} ${creator.lastname} has created an
                                                    ...
                                                    <p><b>We strongly advise you to change your password when you login
                                                        for the first time.</b><br/>
                                                        You can do this by going to <b>My Profile</b> and selecting <b>Change
                                                            Password</b>.</p>
